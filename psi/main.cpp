...
void createSettingsDialog(SAppContext& app)
{
	...
	gui::IGUIWindow* windowSettings = app.Gui->addWindow(rect<s32>(10,10,400,400),true,L"Video settings");
...
int main()
{
	...
	app.Settings = new SettingManager("settings.xml");
	...
	app.Device->setWindowCaption(L"Project Stella Incognita");
